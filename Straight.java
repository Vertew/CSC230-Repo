/**
 * Straight class creates and controls a straight floor tile
 * 
...
class Straight extends Floor {

	final boolean[] ORIGINAL_DIRECTIONS = { true, false, true, false };

	/**
	 * Constructs a new straight tile.
	 * 
	 * @param rotation The rotation of the straight tile.
	 * @param fixed    True if the straight tile is fixed
	 */
	public Straight(int rotation, boolean fixed) {
	 ...
	 * 
	 * @param rotation The rotaion of the straight tile.
	 */
	...
	/**
	 * @return the direction of the straight tile.
	 */
	...
	/**
	 * Makes a new direction for the straight tile.
	 * 
	 * @param rotation The rotation of the straight tile.
	 */
	...
	/**
	 * Applies the rotation to the straight tile.
	 * 
